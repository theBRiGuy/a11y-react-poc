    ...
    <>
      ...
      <section className="hero">
          <div className="container">
              <h1 className="hero__headline">About Us</h1>
              <p className="hero__subhead">An iterative, interactive prototype of an e&#8209;commerce storefront that explores concepts in designing and developing for the web, considering <span className="nobr">accessibility first.</span></p>
          </div>
      </section>
      <div className="about-us__content container">
          <aside className="about-us__sidebar">
              On this page you will find:
              <ul className="about-us__menu">
                  <li className="about-us__menu-item"><a href="#our-story" className="about-us__menu-link">Our Story</a></li>
                  <li className="about-us__menu-item"><a href="#our-team" className="about-us__menu-link">Our Team</a></li>
                  <li className="about-us__menu-item"><a href="#unfulfilled-promise" className="about-us__menu-link">The Unfulfilled Promise of the Internet</a></li>
                  <li className="about-us__menu-item"><a href="#what-the-demo-is" className="about-us__menu-link">What Our Store Is and What It Is Not</a></li>
              </ul>
          </aside>
          <main className="about-us__main">
              <section className="about-us__section">
                  <h2 id="our-story" className="about-us__section-title">Our Story</h2>
                  <p><span aria-label="the accessible e store">The Accessible eStore</span> is an iterative, interactive prototype of an e&#8209;commerce storefront. It explores concepts in designing and developing for the web considering accessibility first. Web accessibility is more of a journey than a destination. In that spirit, this experience will evolve based on our continued learning and user feedback.</p>
              ...
              <section className="about-us__section">
                  <h2 id="our-team" className="about-us__section-title">Our Team</h2>
                  <h3 className="about-us__subsection-title">Development</h3>
                  <ul className="about-us__team-list clearfix">
                      <li>Alison Walden, Senior Director of Technology</li>
                      <li>Alan Evanson</li>
                      <li>Alison Hall</li>
                      <li>Brian Elton</li>
                      <li>Brian Wolk</li>
                      <li>David Jackson</li>
                      <li>Diego Escobar</li>
                      <li>Dustin Sampson</li>
                      <li>Gregory Smith</li>
                      <li>Joel Brown</li>
                      <li>Jonathan Rodness</li>
                      <li>Kristen Nakamura</li>
                      <li>Lisa Kuliczkowski</li>
                      <li>Michael Simla</li>
                      <li>Mike Quattrin</li>
                      <li>Natasha Johnston</li>
                      <li>Noel Tibbles</li>
                      <li>Pauline Ramos</li>
                      <li>Puneet Seghal</li>
                      <li>Rene Noel</li>
                      <li>Suvi Vignarajah</li>
                      <li>Tolu Adegbite</li>
                      <li>Wesley Cocks</li>
                      <li>Yi Wang</li>
                      <li>Zoltan Hawryluk</li>
                  </ul>
                  <h3 className="about-us__subsection-title">User Experience</h3>
                  <ul className="about-us__team-list clearfix">
                      <li>Karen Hawkins, User Experience Lead</li>
                      <li>Alexandra Bernards</li>
                      <li>Catherine Maritan</li>
                      <li>Chris Norman</li>
                      <li>Cole Wheeler</li>
                      <li>Dewey Nguyen</li>
                      <li>Eric Tse</li>
                      <li>Jonas Laufenberg</li>
                      <li>Jordan Morrison</li>
                      <li>Kim Wright</li>
                      <li>Nelson Truong</li>
                      <li>Sasa Djukic</li>
                      <li>Sylvia Wong</li>
                  ...
                  <h3 className="about-us__subsection-title">Visual Design</h3>
                  <ul className="about-us__team-list clearfix">
                      <li>Iris Wu</li>
                      <li>Melanie Wong</li>
                      <li>Paulo Garcia</li>
                  ...
                  <h3 className="about-us__subsection-title">Project Management</h3>
                  <ul className="about-us__team-list clearfix">
                      <li>Rosey Li</li>
                      <li>Laura Beckford</li>
                  </ul>
              </section>
              <section className="about-us__section">
                  <h2 id="unfulfilled-promise" className="about-us__section-title">The Unfulfilled Promise of the Internet</h2>
                  <h3 className="about-us__subsection-title">Introduction</h3>
                  ...
                  <h3 className="about-us__subsection-title">Identifying the problem</h3>
                  ...
                  <ul>
                      ...
                      <li>interactivity that is unavailable to keyboard users, </li>
                      <li>inaccessible modal window content, </li>
                      <li>unclear link labels, or </li>
                  ...
                  <a className="btn" href="https://medium.com/@lsnrae/the-accessible-estore-75b8ca91be1b" target="_blank">Review detailed results for this year on Medium<span className="element-invisible">. Link opens in a new window.</span></a>
              ...
              <section className="about-us__section">
                  <h2 id="what-the-demo-is" className="about-us__section-title">What our demo is, and what it is not</h2>
                  <ul className="what-the-demo__list">
                      <li className="what-the-demo__item"><strong>It is intended to be fully keyboard navigable and screen reader-friendly in its current state.</strong> Navigate with your tab key to discover hidden wayfinding cues, and note how we tried to provide screen reader users with the appropriate amount of context and information as they navigated through the site. Let us know if you experience any issues or have suggestions.</li>
                      <li className="what-the-demo__item"><strong>It is not fully designed.</strong> Think of it as an interactive desktop wireframe right now. We are working out all of the interactions first, then applying an eye-catching design later.</li>
                      <li className="what-the-demo__item"><strong>It is not fully functional</strong> at the moment. For example, right now you can’t add an item to your cart. We plan to make that work shortly. This is as far as we got for Global Accessibility Awareness Day.</li>
                      <li className="what-the-demo__item"><strong>It is not representative of today’s best coding standards – yet.</strong> This code came out of multiple hackathon sessions. The point of the demo today is to showcase how an accessible e&#8209;commerce website should feel and behave. We will clean up the code later.</li>
      ...
      <ul style={{display:'none'}}>
          {/* Pages need to be linked from the root for Parcel */}
          <li><a href="./plp/index.html">Product Listing Page</a></li>
          <li><a href="./pdp/index.html?product_id=1">Product Detail Page</a></li>
          <li><a href="./cart/index.html">Cart Page</a></li>
          <li><a href="./checkout/index.html">Checkout Page</a></li>
          <li><a href="./review-order/index.html">Review Order Page</a></li>
          <li><a href="./order-confirmation/index.html">Confirmation Page</a></li>
      </ul>
      <footer data-template="footer"></footer>
      <div data-template="modal"></div>
      <div data-template="construction-modal"></div>
      {/* Uncomment when ready */}
      {/* <script async src="https://www.googletagmanager.com/gtag/js?id=UA-140213591-1"></script> */}
